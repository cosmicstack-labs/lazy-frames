...
export { prepareComposition, preparePreviewAudio, renderProject } from './render.js';
...
export { assembleAudio, assembleAudioMix, buildMusic, buildNarration, buildSfx, projectAudioCacheDir, sidecarDoctor } from './audio.js';
